...
const it = {
  ...
  paragraph2: 'Sono originaria di <span>Marganets</span>, una città vicino a Nikopol e Zaporižžja, nell’Ucraina sudorientale. Vivevo lì con mio <span>marito</span>, le nostre <span>due figlie</span> e <span>la gatta</span> Malinka. Marganets era la nostra casa, un luogo diricordi e affetti.',
...
const en = {
  paragraph1: 'I\'m 38 years old and this is my story of <span>escapefrom Ukraine</span> in 2022, in search of a better lifein Italy.',
  paragraph2: 'I am originally from <span>Marganets</span>, a citynear Nikopol and Zaporozhye, in south-eastern Ukraine. I lived there with my <span>husband</span>, our <span>two daughters</span> and <span>the cat</span> Malinka.Marganets was our home, a place ofmemories and affections.',
  paragraph3: 'On February 24, 2022, the <span>Russian invasion</span>of Ukraine changed everything. The missiles, the shelters, the bombs: my memories are mixed up in a chaos of fear and destruction. A few hours after the invasion began, I decided to <span>leave withmy daughters</span> and Malinka. My husbandstayed at home, as did my sistersand their children.',
  ...
  paragraph6: 'I realized that I wouldn\'t be able to<span>pay the rent</span>, so we left Pontecorvo. We picked upthe cat again and went to Rome: awoman, two girls and their cat.<span>We started all over again</span> a year after fleeing Ukraine. Wetook a <span>train</span> and asked for help at the hotelCapannelle, a <span>first reception hub</span> set up by the Protection civilian to <span>host the Ukrainiansin the emergency</span>. This hotel shouldalready be closed, but it continues tooperate because the arrivals are notfinished and many people like us are notsettled yet.',
  paragraph7: 'Now that I\'ve moved into the hotel, it\'s not so much my future or that of my daughters that I\'m worried about. What really torments me is the situation of those who remained at home: <span>my head is still inUkraine</span>. I am thinking of returning toUkraine to take and bring with meto Italy my nephews, the children of mysisters. This would make me feel useful and<span>would alleviate the sense of guilt</span> that Ifeel for having left, even thoughmy city is still on the line of forehead.',
  ...
  paragraph20: 'From these data it emerges thatElena\'s story represents one of the many testimonies of Ukrainian refugees inItaly. Despite the challenges and theneed for humanitarian aid, refugees demonstrate a strong will tointegrate and rebuild a better life. The Ukrainian community in Italyis composed mostly ofeducated people, ready to facethe difficulties of adaptation.',
